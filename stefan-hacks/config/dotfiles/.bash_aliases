...
#-----------------------------------------------------------------------
# update
alias update='sudo nala update && sudo nala full-upgrade -y && brew update && brew upgrade && flatpak upgrade && ble-update && tldr --update && sudo update-grub && sudo update-initramfs -u -k all && sudo updatedb -v;figlet "machine is updated !"|lolcat'
